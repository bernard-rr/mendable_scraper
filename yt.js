...
function youtubeVideoScraper(url) {
    return __awaiter(this, void 0, void 0, function () {
        var transcript, content, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, youtube_transcript_1.YoutubeTranscript.fetchTranscript(url)];
                case 2:
                    transcript = _a.sent();
                    content = transcript.map(function (entry) { return entry.text; }).join(' ');
                    return [2 /*return*/, {
                            content: content,
                            source: url
                        }];
                case 3:
                    ...
                    if (error_1 instanceof Error) {
                        throw new Error("Failed to fetch transcript: ".concat(error_1.message));
                    }
                    else {
