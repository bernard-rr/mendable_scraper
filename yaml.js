            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (response.status !== 200) {
                        throw new Error("Failed to fetch with status code: ".concat(response.status));
                    }
                ...
                case 2:
                    ...
                    if (retries === 0)
                        throw error_1;
                    return [2 /*return*/, fetchWithRetry(url, retries - 1)];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    data = _a.sent();
                    parsedYaml_1 = yaml.load(data);
                    sections = Object.keys(parsedYaml_1).map(function (key) {
                        var _a;
                        return {
                            content: yaml.dump((_a = {}, _a[key] = parsedYaml_1[key], _a)),
                            source: url
                        };
                    });
                ...
                case 2:
                    error_2 = _a.sent();
                    console.error("Failed to fetch or parse the YAML:", error_2);
                    return [2 /*return*/, []];
                case 3: return [2 /*return*/];
            }
        });
